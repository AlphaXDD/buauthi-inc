...
exports.run = (client, message, args, tools) => {
  ...
  if (
    ...
    const candyEmb = new Discord.MessageEmbed()
      .setDescription(
        `\`${message.mentions.members.first().user.username}#${message.mentions.members.first().user.discriminator}\` senii, \`${message.author.username}#${message.author.discriminator}\` öptü. <:kalpp:1003711063730159656> <:kalpp:1003711063730159656>`
      )
      .setImage(resimler);
