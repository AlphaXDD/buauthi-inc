...
const etiket = [client.user.id, client.user.username, "<@"+client.user.id+">"]; 
if (etiket.some(etiket => msg.content.includes(etiket))) {
msg.reply("Merhaba yardım almak için !yardım yazabilirsin. ") 
}})
